...
const LandingPage = () => {
  ...
  return (
    <div className="bg-gradient-to-r bg-green-500 to-blue-500 min-h-screen">
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-4 gap-6">
            {Object.keys(loanCategories).map((cat) => (
              <div
                key={cat}
                className="p-6 rounded-lg shadow-xl bg-white hover:bg-blue-200 cursor-pointer transition-all"
                onClick={() => {
                  // Reset subcategory on category change
                  reset({ category: cat, subCategory: "", initialDeposit: "", loanPeriod: "", cnic: "", reason: "" });
                }}
              >
                <h4 className="text-2xl font-semibold text-blue-300">{cat}</h4>
      ...
      <section id="loan-calculator" className="py-20 bg-red-50">
        <div className="container mx-auto text-center">
          <h3 className="text-4xl font-extrabold text-blue-400">Loan Calculator</h3>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full p-4 rounded-lg border focus:ring-2 focus:ring-blue-400"
                  placeholder="Enter your CNIC"
                />
                {errors.cnic && <p className="text-blue-400">{errors.cnic.message}</p>}
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows="3"
                />
                {errors.reason && <p className="text-blue-400">{errors.reason.message}</p>}
              </div>
              ...
              <div className="mb-6">
                ...
                {errors.category && <p className="text-blue-400">{errors.category.message}</p>}
              </div>
              ...
              {category && (
                <div className="mb-6">
                  ...
                  {errors.subCategory && <p className="text-blue-400">{errors.subCategory.message}</p>}
                </div>
              )}
              ...
              <div className="mb-6">
                ...
                />
                {errors.initialDeposit && <p className="text-blue-400">{errors.initialDeposit.message}</p>}
              </div>
              ...
              <button
                type="submit"
                className="bg-blue-500 text-white py-3 px-6 rounded-lg w-full text-lg hover:bg-red-700 transition duration-300"
              >
                Calculate Breakdown
              </button>
            </form>
